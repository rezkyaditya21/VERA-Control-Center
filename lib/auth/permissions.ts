...
export const PERMISSIONS = {
  ...
  PROOFS_VERIFY: 'proofs.verify',
  PROOFS_REJECT: 'proofs.reject',

  // Progress & Milestones
  PROGRESS_VIEW: 'progress.view',
  PROGRESS_MODERATE: 'progress.moderate',
...
const ROLE_PERMISSIONS: Record<AdminRole, PermissionKey[]> = {
  ...
  MODERATOR: [
    ...
    PERMISSIONS.PROOFS_VERIFY,
    PERMISSIONS.PROOFS_REJECT,
    PERMISSIONS.PROGRESS_VIEW,
    PERMISSIONS.PROGRESS_MODERATE,
